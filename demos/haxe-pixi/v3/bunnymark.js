...
samples.v3.bunnymark.Main.prototype = $extend(samples.v3.Application.prototype,{
	...
	,_setup: function() {
		...
		var bunny1 = new PIXI.Texture(this.wabbitTexture.baseTexture,new PIXI.math.Rectangle(2,47,26,37));
		var bunny2 = new PIXI.Texture(this.wabbitTexture.baseTexture,new PIXI.math.Rectangle(2,86,26,37));
		var bunny3 = new PIXI.Texture(this.wabbitTexture.baseTexture,new PIXI.math.Rectangle(2,125,26,37));
		var bunny4 = new PIXI.Texture(this.wabbitTexture.baseTexture,new PIXI.math.Rectangle(2,164,26,37));
		var bunny5 = new PIXI.Texture(this.wabbitTexture.baseTexture,new PIXI.math.Rectangle(2,2,26,37));
