...
samples.v3.video = {};
samples.v3.video.Main = function() {
	samples.v3.Application.call(this);
	this._init();
};
samples.v3.video.Main.main = function() {
	new samples.v3.video.Main();
};
samples.v3.video.Main.__super__ = samples.v3.Application;
samples.v3.video.Main.prototype = $extend(samples.v3.Application.prototype,{
	_init: function() {
