...
dragonbones_Main.__name__ = true;
...
dragonbones_Main.prototype = $extend(pixi_plugins_app_Application.prototype,{
	...
	,_replaceDisplay: function() {
		...
		if(replaceDisplayName.indexOf("mesh") >= 0) switch(replaceDisplayName) {
		case "meshA":
		...
		case "mesh":
			...
			break;
		} else this._factory.replaceSlotDisplay("ReplaceSlotDisplay","MyDisplay","ball",replaceDisplayName,this._armatureDisplay2.armature.getSlot("ball"));
	}
});
