...
arm_cohere_components_bunnymark_BunnymarkView.prototype = $extend(arm_cohere_core_components_ComponentView.prototype,{
	...
	,start: function() {
		...
		this._bunnyContainer = new PIXI.particles.ParticleContainer();
	...
	,end: function() {
		...
		if(arm_cohere_Main.update != null) arm_cohere_Main.update.remove($bind(this,this._update));
		if(arm_cohere_Main.resize != null) arm_cohere_Main.resize.remove($bind(this,this._resize));
	}
...
arm_cohere_components_menu_MenuView.prototype = $extend(arm_cohere_core_components_ComponentView.prototype,{
	setup: function() {
		...
		this._demoList = this._menu.add(this._data,"demo",["none","Retina","Bunnymark","Spritesheet","Bitmapfont","Graphics","Rope","Tween","Physics"]);
...
var arm_cohere_components_physics_PhysicsController = function() {
	arm_cohere_core_components_ComponentController.call(this);
};
$hxClasses["arm.cohere.components.physics.PhysicsController"] = arm_cohere_components_physics_PhysicsController;
arm_cohere_components_physics_PhysicsController.__name__ = ["arm","cohere","components","physics","PhysicsController"];
arm_cohere_components_physics_PhysicsController.__super__ = arm_cohere_core_components_ComponentController;
arm_cohere_components_physics_PhysicsController.prototype = $extend(arm_cohere_core_components_ComponentController.prototype,{
	setup: function() {
		this.model.get_currentDemoChanged().add($bind(this,this._onCurrentDemoChange));
	}
	,_onCurrentDemoChange: function(from,to) {
		if(to == "physics") this.view.start(); else this.view.end();
	}
	,__class__: arm_cohere_components_physics_PhysicsController
});
var arm_cohere_components_physics_PhysicsView = function(mainView,viewName) {
	arm_cohere_core_components_ComponentView.call(this,mainView,viewName);
};
$hxClasses["arm.cohere.components.physics.PhysicsView"] = arm_cohere_components_physics_PhysicsView;
arm_cohere_components_physics_PhysicsView.__name__ = ["arm","cohere","components","physics","PhysicsView"];
arm_cohere_components_physics_PhysicsView.__super__ = arm_cohere_core_components_ComponentView;
arm_cohere_components_physics_PhysicsView.prototype = $extend(arm_cohere_core_components_ComponentView.prototype,{
	addAssetsToLoad: function() {
		this.loader.addAsset("nape_ball","nape/ball.png");
	}
	,start: function() {
		this._balls = [];
		this._pballs = [];
		...
		this._timer.run = $bind(this,this._addBall);
		this._addBall();
		if(arm_cohere_Main.update != null) arm_cohere_Main.update.add($bind(this,this._update));
	}
	,_setUpPhysics: function() {
		...
		this._floor.zpp_inner.wrap_shapes.add(new nape_shape_Polygon(nape_shape_Polygon.rect(0,window.innerHeight,window.innerWidth,1)));
		this._floor.set_space(this._space);
	}
	,_addBall: function() {
		var ball = new PIXI.Sprite(this.loader.getTexture("nape_ball"));
		ball.anchor.set(0.5);
		this._balls.push(ball);
		this._container.addChild(ball);
	...
	,__class__: arm_cohere_components_physics_PhysicsView
});
...
var arm_cohere_components_tween_TweenController = function() {
	arm_cohere_core_components_ComponentController.call(this);
};
$hxClasses["arm.cohere.components.tween.TweenController"] = arm_cohere_components_tween_TweenController;
arm_cohere_components_tween_TweenController.__name__ = ["arm","cohere","components","tween","TweenController"];
arm_cohere_components_tween_TweenController.__super__ = arm_cohere_core_components_ComponentController;
arm_cohere_components_tween_TweenController.prototype = $extend(arm_cohere_core_components_ComponentController.prototype,{
	setup: function() {
		this.model.get_currentDemoChanged().add($bind(this,this._onCurrentDemoChange));
	}
	,_onCurrentDemoChange: function(from,to) {
		if(to == "tween") this.view.start(); else this.view.end();
	}
	,__class__: arm_cohere_components_tween_TweenController
});
var arm_cohere_components_tween_TweenView = function(mainView,viewName) {
	arm_cohere_core_components_ComponentView.call(this,mainView,viewName);
};
$hxClasses["arm.cohere.components.tween.TweenView"] = arm_cohere_components_tween_TweenView;
arm_cohere_components_tween_TweenView.__name__ = ["arm","cohere","components","tween","TweenView"];
arm_cohere_components_tween_TweenView.__super__ = arm_cohere_core_components_ComponentView;
arm_cohere_components_tween_TweenView.prototype = $extend(arm_cohere_core_components_ComponentView.prototype,{
	get_x: function() {
		return this._x;
	}
	...
	,start: function() {
		this._twnObj = new PIXI.Sprite(this.loader.getTexture("preloader_logo"));
		this._twnObj.anchor.set(0.5);
		this._twnObj.alpha = 0;
		this._container.addChild(this._twnObj);
		motion_Actuate.tween(this._twnObj,2,{ alpha : 1}).repeat().reflect().delay(1);
		this._resize();
		if(arm_cohere_Main.resize != null) arm_cohere_Main.resize.add($bind(this,this._resize));
	}
	,end: function() {
	...
	,__class__: arm_cohere_components_tween_TweenView
...
nape_phys_Body.prototype = $extend(nape_phys_Interactor.prototype,{
	...
	,__properties__: {get_position:"get_position",set_space:"set_space",set_type:"set_type"}
});
...
nape_shape_Shape.prototype = $extend(nape_phys_Interactor.prototype,{
	...
	,__properties__: {set_material:"set_material"}
});
...
arm_cohere_components_physics_PhysicsController.__meta__ = { fields : { view : { type : ["arm.cohere.components.physics.PhysicsView"], inject : null}}};
...
arm_cohere_components_tween_TweenController.__meta__ = { fields : { view : { type : ["arm.cohere.components.tween.TweenView"], inject : null}}};
