...
arm_cohere_components_bitmapfont_BitmapfontView.prototype = $extend(arm_cohere_core_components_ComponentView.prototype,{
	...
	,start: function() {
		...
		this._bitmapFont.position.x = (window.innerWidth - this._bitmapFont.width) / 2;
		this._bitmapFont.position.y = (window.innerHeight - this._bitmapFont.height) / 2;
...
arm_cohere_components_preloader_PreloaderView.prototype = $extend(arm_cohere_core_components_ComponentView.prototype,{
	...
	,setup: function() {
		...
		arm_cohere_Main.update.add($bind(this,this._onUpdate));
		arm_cohere_Main.resize.add($bind(this,this._onResize));
	}
	,_onLoaded: function() {
		...
		this._container.position.set(this.stageProperties.screenWidth / 2,this.stageProperties.screenHeight / 2 - 100);
		this.loader.reset();
		this.ready.dispatch();
	}
	...
	,reset: function() {
		arm_cohere_Main.update.remove($bind(this,this._onUpdate));
		arm_cohere_Main.resize.remove($bind(this,this._onResize));
	...
	,_onUpdate: function(elapsed) {
		if(this._loadingBar != null) this._loadingBar.scale.x = this.loader.loadProgress / 100;
	}
	,_onResize: function() {
		this._container.position.set(this.stageProperties.screenWidth / 2,this.stageProperties.screenHeight / 2);
	}
